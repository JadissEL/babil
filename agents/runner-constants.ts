...
export const RETRY_MAX_DELAY_MS = Number(process.env.AGENT_RETRY_MAX_DELAY_MS || 6 * 60 * 60 * 1000)
...
export const AGENT_MAX_RUNTIME_MS = Math.max(0, Math.floor(Number(process.env.AGENT_MAX_RUNTIME_MS || 0)))
