...
function ModuleTile({ module }: { module: ModuleDescriptor }) {
  ...
  return (
    <Link
      href={module.link}
      className="group relative flex flex-col rounded-xl border bg-white p-6 transition-all duration-200 hover:border-[#0D1B3E]/30 hover:shadow-sm"
      style={{ borderColor: INK_10 }}
    >
      ...
      <span className="mt-4 inline-flex items-center gap-1 text-[11px] font-black uppercase tracking-[0.22em] text-[#0D1B3E] transition-all group-hover:gap-2">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <aside className="lg:sticky lg:top-6 lg:self-start">
            ...
            >
              ...
              <Link
                href={explorerHref}
                className="mt-6 inline-flex w-full items-center justify-center gap-1.5 rounded-md border bg-[#FAF7EE] px-4 py-3 text-[11px] font-black uppercase tracking-[0.22em] text-[#0D1B3E] transition-colors hover:border-[#0D1B3E] hover:bg-white"
                style={{ borderColor: INK_10 }}
              >
