    ...
    <div className="mx-auto max-w-4xl pb-20">
      <div className="mb-10 flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-4xl font-black tracking-tight text-text">Votre profil</h1>
            <p className="font-medium text-muted">Pour des analyses personnalisées.</p>
          </div>
        </div>
        ...
        <button
          ...
          onClick={handleSave}
          disabled={saving}
          className="flex items-center gap-2 rounded-2xl bg-primary px-8 py-4 font-black text-white shadow-soft transition-all hover:bg-primary-hover disabled:opacity-50"
        >
          {saving ? (
            'Enregistrement…'
          ) : (
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-2xl border border-line bg-[#f8f2e8] p-4">
              ...
              <button
                ...
                className={`relative h-6 w-12 rounded-full transition-colors ${profile.CNSS_status ? 'bg-primary' : 'bg-[#b8c1cf]'}`}
              >
                <div
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between rounded-2xl border border-line bg-[#f8f2e8] p-4">
              ...
              <button
                ...
                className={`relative h-6 w-12 rounded-full transition-colors ${profile.family_in_europe ? 'bg-primary' : 'bg-[#b8c1cf]'}`}
              >
                <div
        ...
        {/* Goals */}
        <section className="space-y-6 rounded-[2.5rem] border border-line bg-surface p-8 shadow-card md:col-span-2">
          <h2 className="mb-2 flex items-center gap-2 text-xl font-black text-text">
