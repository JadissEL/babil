...
export const COUNTRY_INTELLIGENCE_CONTRACT_V2: CountryFieldSpec[] = [
  ...
  { key: 'economy_gdp_usd', path: 'full_data.economy.gdp_usd', domain: 'signals', critical: true, expectedType: 'number', justification: 'Economy signal on country intelligence; completeness also accepts full_data.economy.gdp_wb_series_unavailable when World Bank has no separate series (territories).', acquisition: 'api' },
