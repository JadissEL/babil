...
export function SiteHeader() {
  ...
  return (
    <>
      ...
      <div className="border-b border-line bg-primary-soft/25 py-2 pl-[max(1rem,env(safe-area-inset-left,0px))] pr-[max(1rem,env(safe-area-inset-right,0px))] md:hidden">
