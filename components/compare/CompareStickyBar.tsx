...
export function CompareStickyBar({ names, max, onClear, onScrollToTable }: CompareStickyBarProps) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 flex justify-center px-4 pb-4 pt-2">
      <div className="pointer-events-auto flex w-full max-w-4xl flex-col gap-3 rounded-2xl border border-white/15 bg-[#0B0F19]/95 px-4 py-3 shadow-2xl shadow-black/40 backdrop-blur md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-2 text-sm text-slate-200">
          <Scale className="h-5 w-5 shrink-0 text-blue-400" aria-hidden />
