      ...
      {open ? (
        <>
          ...
          <div
            ...
            aria-modal="true"
            className={cn(
              'fixed left-3 right-3 top-[max(5rem,calc(4.25rem+env(safe-area-inset-top,0px)))] z-[70] max-h-[min(28rem,calc(100dvh_-_8rem_-_env(safe-area-inset-top,0px)_-_env(safe-area-inset-bottom,0px)))] overflow-hidden rounded-2xl border border-line bg-surface shadow-card sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:max-h-[min(70dvh,24rem)] sm:w-[min(100vw-2rem,22rem)]',
            )}
          >
            ...
            <ul className="max-h-[min(45dvh,calc(100dvh_-_12rem_-_env(safe-area-inset-top,0px)_-_env(safe-area-inset-bottom,0px)),18rem)] overflow-y-auto p-2 sm:max-h-[min(55dvh,16rem)]">
              {!loaded ? (
